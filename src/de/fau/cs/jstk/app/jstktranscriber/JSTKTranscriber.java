...
public class JSTKTranscriber extends JFrame implements KeyListener,
	...
	public JSTKTranscriber(String title) throws Exception {
		super(title, "mainWindow");

		preferences = new JSTKTranscriberPreferences("JSTKTranscriber.ini");
	...
	public static void main(String[] args) throws Exception {
		...
		new JSTKTranscriber("JSTK Transcriber");
	}
